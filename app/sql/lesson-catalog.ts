...
export const lessons: readonly LessonCatalogItem[] = [
  ...
  },
  {
    ...
    summary:
      "Change stored rows with INSERT, UPDATE, DELETE, RETURNING, and ON CONFLICT upserts.",
    meta: "INSERT · UPDATE · DELETE · UPSERT",
    time: "15 min",
  },
  {
    id: "mvcc",
    label: "Lesson 06",
    number: "6",
    title: "MVCC and row versions",
    slug: "mvcc",
    routeModule: "routes/mvcc.tsx",
    cliExampleModule: "mvcc.sql.ts",
    href: "/lessons/mvcc",
    summary:
      "Read the hidden xmin/xmax columns PostgreSQL keeps on every row, and watch them change across a real BEGIN ... COMMIT.",
    meta: "MVCC · XMIN · XMAX",
    time: "20 min",
  },
  {
